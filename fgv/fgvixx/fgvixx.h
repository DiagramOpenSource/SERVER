...
#define ixx_lseek(a,b,c)     ((long)lseek(a,b,c))
#define ixx_cierra           close
#define ixx_dat_cierra       close
#define ixx_lck_lseek(a,b,c) ((long)lseek(a,b,c))
...
extern int ixx_directo_abre_datos(char *,char **,char *,short *,IXXFILE *,int *,FgvStdTabla *,char *pathdef, int ixx_fd);
...
extern int dat_abre(char *,char **,char *,short *,IXXFILE *,int *,FgvStdTabla *,char *pathdef,int ixx_fd);
...
extern int dbf_abre(char *,char **,char *,short *,IXXFILE *,int *,FgvStdTabla *,char *pathdef, int ixx_fd);
...
#ifdef CISAM_DAT
extern int (*ixxdat_abre)(char *,char **,char *,short *,IXXFILE *,int *,FgvStdTabla *,char *pathdef,int ixx_fd) = dat_abre;
...
int (*ixxdiu_abre)(char *,char **,char *,short *,IXXFILE *,int *,FgvStdTabla *,char *pathdef, int ixx_fd) = dat_abre;
int (*ixxdiu_cierra)(int) = dat_cierra;
int (*ixxdiu_graba)(int,long,Uchar *,int) = dat_graba;
int (*ixxdiu_borra)(int,long,int) = dat_borra;
#else
extern int (*ixxdat_abre)(char *,char **,char *,short *,IXXFILE *,int *,FgvStdTabla *,char *pathdef , int ixx_fd) = dbf_abre;
...
int (*ixxdiu_abre)(char *,char **,char *,short *,IXXFILE *,int *,FgvStdTabla *,char *pathdef, int ixx_fd) = dbf_abre;
...
extern int diu_abre(char *,char **,char *,short *,IXXFILE *,int *,FgvStdTabla *,char *pathdef, int ixx_fd);
...
extern int (*ixxdat_abre)(char *,char **,char *,short *,IXXFILE *,int *,FgvStdTabla *,char *pathdef, int ixx_fd);
...
extern int (*ixxdiu_abre)(char *,char **,char *,short *,IXXFILE *,int *,FgvStdTabla *,char *pathdef, int ixx_fd);
