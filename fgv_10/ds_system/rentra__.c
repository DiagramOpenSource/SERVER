...
*---------------------------------------------------------------------------*/
extern int  entra(qp,maxqc,qi,qs,qd,qh,qo)
int qp,
...
char *qi,*qs,*qd,*qo;
{
   ...
   if (maxqc > 0)
   {
      ...
      if (!rentra_edicion && DespachadorExterno)
      {
          char tmp[512];
          int posi;
          ...
          total = sizeof(int)*8 + strlen(qi) + strlen(qs) + strlen(qo) + 3;

          memcpy(tmp+posi,&total,sizeof(int));
          posi += sizeof(int);

          memcpy(tmp+posi,&maxqc,sizeof(int));
          posi += sizeof(int);
          memcpy(tmp+posi,&qh,sizeof(int));         
          posi += sizeof(int);
          memcpy(tmp+posi,&tipo,sizeof(int));         
          posi += sizeof(int);
          memcpy(tmp+posi,&decimal,sizeof(int));         
          posi += sizeof(int);
          memcpy(tmp+posi,&flag,sizeof(int));
          posi += sizeof(int);

          memcpy(tmp+posi,&id_g_control,sizeof(int));
          posi += sizeof(int);
          memcpy(tmp+posi,&id_g_campo,sizeof(int));
          posi += sizeof(int);          
