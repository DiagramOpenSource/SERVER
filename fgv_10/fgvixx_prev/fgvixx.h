...
#define IXXTIPO_PROCESADOR 'I'  /* Intel */
...
#define IXXMAXFILES 500
#else
#define IXXMAXFILES 50   /* 10 * 5 tareas */
#endif
#endif
...
#define IXXMAXLEVEL 100   /* un indexado de 100 niveles es imposible */
...
#ifdef FGVDOS
/* para WINDOWS-DOS */
#define ixx_crea_nuevo(a)    open(a,O_CREAT|O_TRUNC|O_BINARY|O_RDWR,S_IREAD|S_IWRITE)
...
/* externas */
int   ixx_nuevo_indice(char *,short,IXXCLAVE *,short,char **,char *,FgvStdTabla *);
int   ixx_abre_indice(char *,int,char **,char *,int,FgvStdTabla *);
...
extern int dat_abre(char *,char **,char *,short *,IXXFILE *,int *,FgvStdTabla *);
extern int dat_cierra(int);
extern int dat_lee(int,long,Uchar *,int);
extern int dat_graba(int,long,Uchar *,int);
extern int dat_borra(int,long,int);
extern int dat_tamfichero(int,long,int,long *);

extern int dbf_abre(char *,char **,char *,short *,IXXFILE *,int *,FgvStdTabla *);
extern int dbf_cierra(int);
extern int dbf_lee(int,long,Uchar *,int);
extern int dbf_graba(int,long,Uchar *,int);
...
extern int diu_abre(char *,char **,char *,short *,IXXFILE *,int *,FgvStdTabla *);
extern int diu_cierra(int);
extern int diu_graba(int,long,Uchar *,int);
...
extern int (*ixxdat_abre)(char *,char **,char *,short *,IXXFILE *,int *,FgvStdTabla *);
extern int (*ixxdat_cierra)(int);
extern int (*ixxdat_lee)(int,long,Uchar *,int);
extern int (*ixxdat_graba)(int,long,Uchar *,int);
...
extern int (*ixxdiu_abre)(char *,char **,char *,short *,IXXFILE *,int *,FgvStdTabla *);
